    ...
    try {
        ...
        if (userExist) {
            ...
            if (isPasswordCorrect) {
                const tkn = jwt.sign({ userId: userExist._id, email: userExist.email }, process.env.JWT_SECRET, { expiresIn: "1h" });
...
module.exports = { userRegister, userLogin, allUsers,  getBorrowedBooks }